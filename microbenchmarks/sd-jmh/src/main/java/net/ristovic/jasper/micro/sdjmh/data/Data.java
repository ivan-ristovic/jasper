package net.ristovic.jasper.micro.sdjmh.data;
...
import net.ristovic.jasper.micro.sdjmh.data.gen.*;
import net.ristovic.jasper.micro.sdjmh.data.model.*;
    ...
    private static Class<?> resolveClass(String type) {
        ...
        if (!type.contains(".")) {
            String[] packagePrefixes = {
                "net.ristovic.jasper.micro.sdjmh.data.model.",
                "net.ristovic.jasper.micro.sdjmh."
            };
